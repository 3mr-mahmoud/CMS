...
window.Delete = function (element) {
  ...
  axios.delete(target).then(function (response) {
    flash(response.data);
...
window.save = function (el) {
  ...
  axios.patch(action, data).then(function (response) {
    errorFlash('');
...
Vue.component('error-flash', __webpack_require__(47));
var app = new Vue({
  el: '#app'
});
...
window.pluralize = __webpack_require__(13);
window.ArrayMove = __webpack_require__(14);
...
Component.options.__file = "resources\\assets\\js\\components\\errorFlash.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-32b76d5f", Component.options)
  } else {
    hotAPI.reload("data-v-32b76d5f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        if (!Array.isArray(this.errorsobject)) this.flash(this.errorsobject);
        window.events.$on('errorFlash', function (errorsObject) {
            return _this.flash(errorsObject);
        });
    },

    methods: {
        flash: function flash(errorsObject) {
            if (!errorsObject) {
                this.show = false;return;
            }
            this.dataObject = errorsObject;
            this.show = true;
        }
    }
});
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.dataObject, function(value, key) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-32b76d5f", module.exports)
  }
}
